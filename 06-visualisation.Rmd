...
Rafeal Irizarry on [Why dynamite plots must die](https://simplystatistics.org/2019/02/21/dynamite-plots-must-die/)
...
The previous plot showed us changes with time, but
averages and spread or other statistical summaries of the data might be more informative
