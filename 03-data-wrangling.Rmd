...
have match in both tables using the primary key of `date` and `plot`.

```{r inner-join-fig,fig.asp=1,out.width = '100%', fig.align='center', echo=FALSE,cache=TRUE}
...
`airtemp` and fills the missing observations in `species` with `NA`.

```{r left-join-fig,fig.asp=1,out.width = '100%', fig.align='center', echo=FALSE,cache=TRUE}
...
`krat` and fills the missing observations in `airtemp` with `NA`.

```{r right-join-fig,fig.asp=1,out.width = '100%', fig.align='center', echo=FALSE,cache=TRUE}
...
both tables and fills the missing observations in `airtemp` and `species` with `NA`.

```{r full-join-fig,fig.asp=1,out.width = '100%', fig.align='center', echo=FALSE,cache=TRUE}
...
in `airtemp` that matches in `krat`. 

```{r semi-join-fig,fig.asp=1,out.width = '100%', fig.align='center', echo=FALSE,cache=TRUE}
...
in `airtemp` that match in `krat`. 

```{r anti-join-fig,fig.asp=1,out.width = '100%', fig.align='center', echo=FALSE,cache=TRUE}
