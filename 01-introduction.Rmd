...
If, when faced with the thought of starting to learning to code you feel like an imposter, \@ref(fig:imposter):
...
Then hopefully by the end of these materials, you'll feel a bit more like a R cat, \@ref(fig:rcat):
