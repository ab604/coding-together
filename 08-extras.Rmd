...
This chapter extra chapter introduces: 
...
Use brackets `()` to group plots and backslash `\` to create a new row:
...
lifexp_bubble / (asia_lollipop | lifexp_box) + plot_annotation(tag_levels = "A")
```
