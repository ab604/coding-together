...
The main sources used here are: [R for data science (R4DS)](https://r4ds.had.co.nz/), [the R4DS community](https://www.rfordatasci.com/), [the Carpentries](https://carpentries.org/),
